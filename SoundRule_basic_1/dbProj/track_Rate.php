...
//    echo '<form action = "http://localhost/ps3/bookings.php" method="post">';
    ...
    $query1 = "select t.tid, t.tname, t.aname, t.tdur, r.score
            from tracks as t join albums as b on t.abid = b.abid
            where t.abid = '%".$abid."%'";
    $response1 = @mysqli_query($dbc, $query1);
        
    $query3 = "select t.tid, t.tname, t.aname, t.tdur
                from tracks as t join albums as b on t.abid = b.abid
                where t.abid = '%".$abid."%';";
        ...
        while($row = mysqli_fetch_array($response1)){
            ...
            echo '<td align="left">' . 
                ...
                <td align = "left">'.
                    '<form action = "tracks.php" method = "post">
                        <input type = "number" name = "score" value = "" size = 1 min=1 max=5>
                        <input type="submit" name="rerate" value="Rate" class="btn btn-primary">
                        <input type = "hidden" name = "tid" value = "'.$tid.'">
                        <input type = "hidden" name = "abid" value = "'.$abid.'">
                        <input type = "hidden" name = "uname" value = "'.$uname.'">
                    </form>
...
//    echo '<form action = "http://localhost/ps3/bookings.php" method="post">';
    ...
    $query1 = "select t.tid, t.tname, t.aname, t.tdur, r.score
            from tracks as t join albums as b on t.abid = b.abid
			join rating r on t.tid = r.tid
            where t.abid = '%".$abid."%' and r.uname = '".$uname."' and tid = '".$tid."';";
    $response1 = @mysqli_query($dbc, $query1);
        
    $query3 = "select t.tid, t.tname, t.aname, t.tdur, r.score, r.uname
                from tracks as t join albums as b on t.abid = b.abid
                join rating r on t.tid = r.tid
                where t.abid = '%".$abid."%' and r.tid != (select t.tid
											from tracks t join albums b on t.abid = b.abid
													join rating r on t.tid = r.tid
											where t.abid = '".$abid."' and r.uname = '".$uname."');";
    $response3 = @mysqli_query($dbc, $query3);
            ...
            echo '<td align="left">' . 
                ...
                <td align = "left">'.
                    '<form action = "tracks.php" method = "post">
                        ...
                        <input type="submit" name="reRateAlb" value="Rate" class="btn btn-primary">
                        <input type = "hidden" name = "tid" value = "'.$tid.'">
                        <input type = "hidden" name = "abid" value = "'.$abid.'">
                        <input type = "hidden" name = "uname" value = "'.$uname.'">
                    </form>
...
//    echo '<form action = "http://localhost/ps3/bookings.php" method="post">';
    ...
    $query2 = "update rating 
    set score = '".$score."', rtime = now()
