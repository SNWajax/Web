...
//    echo '<form action = "http://localhost/ps3/bookings.php" method="post">';
    ...
    $query1 = "SELECT t.tname, t.aname, ab.abtitle, t.tid
                from tracks t join albums ab on t.abid = ab.abid 
                where t.tname LIKE '%".$key."%' or ab.abtitle LIKE '%".$key."%' or t.aname LIKE '%".$key."%'";
...
<table align="left" cellspacing="5" cellpadding="8" class="table table-dark table-hover">
    ...
    echo '</table> <h1>No result found!</h1>';

    } else {

        echo "Couldn't issue database query<br />Data not present";
